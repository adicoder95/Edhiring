...
exports.singleJob = async (req, res, next) => {
    try {
        ...
        const application = await Application.findOne({ job: job, candidate: user });
...
exports.updateApplicationStatus = async (req, res, next) => {
    try {
        ...
        // Find the application using candidateId and jobId
        ...
        // Record the activity (assuming recordActivity function is implemented)
        await recordActivity(req.user.id, 'updatedApplicationStatus', `Successfully updated status for application of candidate: ${candidateId} for job: ${jobId}`);
