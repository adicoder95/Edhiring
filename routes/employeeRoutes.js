...
const { getEmployerProfile, updateEmployerProfile, getInstituteInfo, getCandidateProfileById, getProfileViews } = require('../controllers/employeeController');
...
router.post('/profile/candidate', isAuthenticated, getCandidateProfileById);
